...
# indentation make me want to kms
...
def write_notes_to_pdf(notes, output_path, font_path, font_name, font_size, margins, line_spacing, font_color_hex):
    ...
    for slide_text in notes:
        for line in slide_text.split('\n'):
            wrapped_lines = wrap_text(line, actual_font_name, font_size, width - margins['left'] - margins['right'])
        ...
        y -= line_spacing  # Space between slides
    c.save()
